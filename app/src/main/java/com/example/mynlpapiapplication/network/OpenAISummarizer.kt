    ...
    suspend fun summarizeUrl(
        ...
        return withContext(runOn) {
            val requestBody = JSONObject()
                ...
                .put("prompt", urlString )//context.resources.getString(R.string.url_prompt).format(urlString))
            ...
            try {
                Gson().fromJson(responseBody, OpenAISummarizerResponse::class.java).putInfo(
                    urlString,
                    maxTokens,
                    temperature,
                    response.code,
                ...
                OpenAISummarizerResponse().putInfo(
                    urlString,
                    maxTokens,
                    temperature,
                    response.code,
